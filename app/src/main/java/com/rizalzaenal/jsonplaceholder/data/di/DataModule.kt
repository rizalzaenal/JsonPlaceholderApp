...
import com.rizalzaenal.jsonplaceholder.data.repository.*
...
class DataModule {
    ...
    @Provides
    fun provideAlbumRepository(service: JsonPlaceHolderService): AlbumRepository {
        return AlbumRepositoryImpl(service)
    }
}